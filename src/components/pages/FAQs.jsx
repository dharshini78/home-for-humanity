...
const FAQs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://homeforhumanity.onrender.com/comments",
        formData,
        {
          headers: {
    ...
    <>
      ...
      <div className="p-4 max-w-4xl mx-auto">
        <div className="p-3 max-w-4xl mx-auto">
          <h1 className="ff-xl font-bold mb-4 mini">
        ...
        <div className="p-3 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-4 mini">
            {translations
              ? translations["Have any more questions?"]
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="px-8 bg-gray-800 text-smmm text-white py-2 border border-gray-300"
            >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 p-4">
            <div className="bg-white p-6 rounded-lg w-full max-w-md relative">
              <button
                onClick={closeModal}
                className="absolute top-2 right-2 p-4 text-gray-600 hover:text-gray-900"
              >
                <IoMdClose size={24} color="black" />
              </button>
              <h2 className="ff-xl font-bold mb-4">
                {translations ? translations["Post Comment"] : "Post Comment"}
              </h2>
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label className="block text-gray-700">
                ...
                <button
                  type="submit"
                  className="w-1/2 bg-gray-800 text-white py-2 border border-gray-300"
                >
                  {translations ? translations.Submit : "Submit"}
                </button>
              </form>
