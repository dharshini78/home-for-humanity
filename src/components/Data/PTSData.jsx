...
const data = [
  {
    ...
    steps: [
      ...
      {
        description:
          "Mark the dimensions of the shelter. Place a stone on each of the marked points.",
        img: img004,
        materials: ["Stones"],
        labor: "1-2 men",
      },
      {
        description:
          "Where you have placed a stone, dig a hole about 40 cm deep.",
        img: img005,
        materials: ["Shovel / Spade / Pickaxe"],
        labor: "1-2 men",
      },
      {
        description:
          "Pile the soil far enough away from the holes to prevent collapse.",
        img: img006,
        materials: ["Shovel / Spade / Pickaxe"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          " …and fill the hole with soil. about 30 cm of the column should be buried.",
        img: img009,
        materials: ["Shovel / Spade / Pickaxe"],
        labor: "1-2 men",
      },
      {
        description:
          "Make sure the column is well buried and water will drain away from the wood.",
        img: img010,
      ...
      {
        description:
          "If the column is not stable, add nails or a wooden anchor.",
        img: img011,
        materials: ["Nails or wooden anchor"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Nail the ridge beam to the column or use ropes, if nails are not available.",
        img: img013,
      ...
      {
        description:
          "Connect the two posts well. Use at least two nails at an angle.",
        img: img014,
        materials: ["Nails or ropes"],
        labor: "1-2 men",
      },
      {
        description:
          "If nails can not be used or are not sufficient, use ropes.",
        img: img015,
        materials: ["Ropes"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Make the base wall out of masonry. make the base 4.3 m long 3.75 m wide and 90 cm high.",
        img: img017,
      ...
      {
        description:
          "After laying one layer of bricks, build up the corners to full height. Then complete the walls.",
        img: img018,
        materials: ["Masonry bricks (3.5  m³, Approximately 800 bricks)"],
        labor: "2-3 men",
      },
      ...
      {
        description:
          "Place the rafters on the stone foundation, measure and mark their length.",
        img: img020,
      ...
      {
        description:
          "Cut the rafters to length, and place them back into the hole and fix them to the ridge beam.",
        img: img021,
      ...
      {
        description:
          "Make sure the rafters are properly fixed to the ridge beam.",
        img: img022,
        materials: ["Nails or ropes"],
        labor: "1-2 men",
      },
      {
        description:
          "Make sure the foundation is deep enough and water drains away from the wood.",
        img: img023,
        materials: ["Shovel / Spade / Pickaxe"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Cut the remaining plastic sheet along the above shown pattern.",
        img: img027,
      ...
      {
        description:
          "Attach one triangle at the front and one at the back of the shelter.",
        img: img028,
        materials: ["Plastic sheeting (3x 4.00 x 6.00 m)"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Use a piece of wood to fix the plastic sheeting onto the masonry wall.",
        img: img031,
      ...
      {
        description:
          "Gather dry plant material and rags to be used as insulation.",
        img: img032,
      ...
      {
        description:
          "Make packages of insulation material to be put on the roof.",
        img: img033,
        materials: ["Dry plant material, Rags"],
        labor: "1-2 men",
      },
      {
        description:
          "Place the insulation material on the roof between plastic sheeting and purlin.",
        img: img034,
        materials: ["Dry plant material, Rags"],
        labor: "1-2 men",
      },
      {
        description:
          "Add the roof sheeting on top of the purlins and nail them to the structure.",
        img: img035,
        materials: ["Dry plant material, Rags"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Overlap the sheets. Use umbrella or twisted roofing nails.",
        img: img037,
      ...
      {
        description:
          "Cut the remaining 4 m long plastic sheeting in two 1 m wide stripes.",
        img: img038,
        materials: ["Knife, Plastic sheeting (3x 4.00 x 6.00 m)"],
        labor: "1-2 men",
      },
      {
        description:
          "Nail the two strips on top of the roof to cover the gap between the metal sheets.",
        img: img039,
      ...
      {
        description:
          "Tie the ropes to stakes. Angle the stakes for better support.",
        img: img041,
      ...
      {
        description:
          "Place the other two guy ropes along the side and tie them down in the same way.",
        img: img042,
        materials: ["Guy ropes (Polyethylene rope dia. 12 mm, L=50 m)"],
        labor: "1-2 men",
      },
...

  {
    ...
    steps: [
      ...
      {
        description:
          "Add splashes of water to cure the earth and ram it to make an even and solid surface.",
        img: loggies07,
      ...
      {
        description:
          "Next, prepare the wooden dowels with an edge tool to match the diameter of the bamboo.",
        img: loggies31,
      ...
      {
        description:
          "Cut the dowel flush with the bamboo. Add a 12 cm long piece of threaded rod in the center.",
        img: loggies34,
      ...
      {
        description:
          "Cut a wedge shape at both ends of the bamboo pole. Add the dowel and secure with a nail.",
        img: loggies36,
        materials: ["Hammer", "Wooden dowels", "Nails"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Cut P into following lengths with a saw. Each bamboo length is needed 8 times.",
        img: loggies88,
        materials: ["Saw"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Make sure the space is even. Next repeat with other sections of the.",
        img: loggies92,
        materials: ["Bamboo tubes"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Add 10cm layer of crushed stones and incorporate into the earth with rammer and cure with water.",
        img: loggies120,
...

  {
    ...
    steps: [
      ...
      {
        description:
          "Finish the first side of the roof. Make sure that the ridge panels are overlapping.",
        img: tem51,
...

  {
    ...
    steps: [
      {
        description:
          "Prepare the site, remove obstacles such as stones and flatten the ground.",
        img: indo1,
        materials: ["Shovel / Spade"],
        labor: "1-2 men",
      },
      {
        description:
          "Mark the position of the foundations. It is a rectangle if the diagonals have the same length.",
        img: indo2,
      ...
      {
        description:
          "Insert the four main foundations and cover them well with the surrounding gravel.",
        img: indo4,
      ...
      {
        description:
          "Leave the secondary foundation holes. Cut indentations for the roof into the four main columns.",
        img: indo5,
      ...
      {
        description:
          "Mark the indentation at the upper end of the columns using a pen.",
        img: indo6,
      ...
      {
        description:
          "Cut the indentation using a saw. This will form the support for the diagonal roof beams.",
        img: indo7,
        materials: ["Saw to cut the bamboo to length"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "The column is fitted on top of the steel plug in the foundation.",
        img: indo9,
        materials: ["4 x Concrete foundations with steel plug"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Use a rope to knot the horizontal beams to the vertical columns.",
        img: indo11,
      ...
      {
        description:
          "Make sure to leave enough space for a second beam below the first.",
        img: indo12,
      ...
      {
        description:
          "Tighten all knots firmly to ensure a stable connection between all elements.",
        img: indo13,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Repeat the steps for all elements. Knot together the upper beams where they meet.",
        img: indo15,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Use an extra piece of rope to ensure a solid connection between the two beams.",
        img: indo16,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Attach the secondary columns to the beams using the same knot as shown before.",
        img: indo17,
      ...
      {
        description:
          "Wrap a plastic bag around the foot of the columns to protect against humidity and pests.",
        img: indo18,
      ...
      {
        description:
          "The final shelter will have openings for windows and doors.",
        img: indo21,
        materials: [],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Apply the steps to both ends consecutively. First mark and cut the slant in the bamboo.",
        img: indo23,
        materials: ["Saw to cut the bamboo to length"],
        labor: "1-2 men",
      },
      {
        description:
          "Carve the notch for the rope and a slit so that the elements fit into one another.",
        img: indo24,
      ...
      {
        description:
          "Attach the bracing at the lower end using a piece of rope.",
        img: indo25,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Repeat the same for the upper end. The final joints look like this.",
        img: indo27,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "First cut the upper ends of both bracing elements as shown before.",
        img: indo29,
        materials: ["Saw to cut the bamboo to length"],
        labor: "1-2 men",
      },
      {
        description:
          "Then connect the bracings with each other using a piece of rope.",
        img: indo30,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Use two more ropes to tighten the first knot and connect to the beam.",
        img: indo31,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Knot together the lower ends with the main columns as shown before.",
        img: indo32,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "First knot the bracing to the column. The rope should go around at least three times.",
        img: indo35,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Use the rest of the rope to connect the bracing with the beam.",
        img: indo36,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Repeat the same for the upper joint, the final joints look like this.",
        img: indo37,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Repeat all of the steps for the wall on the back side of the shelter.",
        img: indo39,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "The finished structure with all bracings will look like this.",
        img: indo40,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "Lay the roof beams for onto the frame and attach it firmly.",
        img: indo41,
      ...
      {
        description:
          "First knot the roof beams to each other to prevent lateral slipping.",
        img: indo42,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Then secure the knot to the horizontal beam with an additional rope.",
        img: indo43,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Lift the main roof frame up and between the supporting beams. Attach it at the intersections.",
        img: indo48,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Attach the main roof frame to the structure with the same knots as shown before.",
        img: indo49,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Build a platform from wooden planks for easier access to the roof. Avoid planks laying on the ground.",
        img: indo50,
      ...
      {
        description:
          "Make sure the planks are sufficiently cantilevered for safety.",
        img: indo51,
        materials: ["12 x Wooden planks L = 5.00 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Cover the whole roof so there is a surface to stand on. Use a ladder for access.",
        img: indo52,
      ...
      {
        description:
          "Make sure to attach the beam firmly so that it doesn't slip from the corner column.",
        img: indo54,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Add the second diagonal beam and cross it over the first one at the ridge purlin.",
        img: indo55,
        materials: ["4x Roof diagonals dia = 0.08m, L = 5.00 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Attach the diagonals to each other as well as to the ridge purlin.",
        img: indo56,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Repeat the step for the other side. Add the two short eaves purlins on top of the diagonals.",
        img: indo57,
        materials: ["2 x Long roof purlins dia = 0.08m, L = 7.90 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Knot the short purlin tightly to the diagonal to prevent it from slipping.",
        img: indo58,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Then add the long eaves purlins on top of the short purlins.",
        img: indo59,
        materials: ["2 x Long roof purlins dia = 0.08m, L = 7.90 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Knot them tightly to both the purlin and diagonal roof beam.",
        img: indo60,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Use the crossed ends of the diagonals as support for a new ridge purlin.",
        img: indo61,
        materials: ["2 x Long roof purlins dia = 0.08m, L = 7.90 m"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Nail each roof lath to the purlin and diagonal with two nails. Be careful to avoid splitting of the bamboo.",
        img: indo64,
        materials: ["1 kg Carpenter nails 40d, 12.5 cm"],
        labor: "1-2 men",
      },
      {
        description:
          "Finish attaching all of the rafters until the whole roof is covered.",
        img: indo65,
        materials: ["1 kg Carpenter nails 40d, 12.5 cm"],
        labor: "1-2 men",
      },
      {
        description:
          "Create the roof panels. Start by splitting the bamboo into smaller laths.",
        img: indo66,
      ...
      {
        description:
          "After splitting, use the knife to clear the laths from sharp edges and irregularities.",
        img: indo67,
        materials: ["Small knife for carving"],
        labor: "1-2 men",
      },
      {
        description:
          "Wrap the palm leaves around the lath one after another and attach using the string and needle.",
        img: indo68,
      ...
      {
        description:
          "Wrap half of the leaf under and the other half over the lath.",
        img: indo69,
        materials: ["≈1440 Leaves from the nipa palm tree", "String & Needle"],
        labor: "1-2 men",
      },
      {
        description:
          "Alternate through each leaf from bottom to top. Make a tight knot in the end to ensure stability.",
        img: indo70,
        materials: ["≈1440 Leaves from the nipa palm tree", "String & Needle"],
        labor: "1-2 men",
      },
      {
        description:
          "Store the finished panels in a dry place. Prevent pests and humidity from destroying them.",
        img: indo71,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "Start adding the panels to the roof, starting from the bottom upwards.",
        img: indo72,
        materials: ["≈1440 Leaves from the nipa palm tree", "String & Needle"],
        labor: "1-2 men",
      },
      {
        description:
          "Use a small piece of string to attach the laths to each of the rafters.",
        img: indo73,
      ...
      {
        description:
          "Repeat this for all panels until the whole roof is covered.",
        img: indo74,
        materials: ["≈1440 Leaves from the nipa palm tree", "String & Needle"],
        labor: "1-2 men",
      },
      {
        description:
          "Create the facade. First add the horizontal bars as a primary support structure.",
        img: indo75,
        materials: ["14 x Short beams dia = 0.08m, L = 3.00 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Attach the bars to the structure using the same knot as before.",
        img: indo76,
        materials: ["Polyethylene rope dia. 10 mm, L=100 m"],
        labor: "1-2 men",
      },
      {
        description:
          "Next add the vertical spacer studs. Create them by splitting the bamboo as shown before.",
        img: indo77,
        materials: ["Big knife for splitting"],
        labor: "1-2 men",
      },
      {
        description:
          "Carve a small hole in the beams to insert the studs. The studs should be about 70 cm apart.",
        img: indo78,
        materials: ["Small knife for carving"],
        labor: "1-2 men",
      },
      {
        description:
          "Repeat adding spacer studs until the whole facade is covered. Leave window and door openings free.",
        img: indo79,
        materials: ["Big knife for splitting"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Interweave the planks between the spacer studs so that they sit firmly.",
        img: indo81,
        materials: ["Bamboo planks W = 16 cm L = 260 m 12.5 cm"],
        labor: "1-2 men",
      },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        description:
          "Pile the soil far enough away from the trench to prevent collapse.",
        img: sup4,
        materials: ["Shovel / Spade / Pickaxe"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Leave around 50 cm of space between the gravel and the edge of the trench.",
        img: sup7,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "Unroll the polypropylene tubes and lay them out in the trench to measure the length.",
        img: sup8,
      ...
      {
        description:
          "Tie a knot in one end of the tube, and feed it onto the loading chute.",
        img: sup10,
      ...
      {
        description:
          "Place the first tube towards the inside of the circle, so another layer fits next to it. Fill it with gravel.",
        img: sup11,
        materials: ["15m3 of gravel"],
        labor: "1-2 men",
      },
      {
        description:
          "Tamper from the middle of the wall towards the end and beginning of the tube.",
        img: sup12,
        materials: ["Tampers"],
        labor: "1-2 men",
      },
      {
        description:
          "When you reach the end, fill it generously. Twist and tie a knot in the end.",
        img: sup13,
        materials: [],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Add a second course to the outside. Make sure to start in a different location.",
        img: sup15,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "On each tube, lay two strings of barbed wire along the whole course.",
        img: sup16,
      ...
      {
        description:
          "Start the next layer. Start in a different position than the layer below.",
        img: sup17,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "Continue until you reach ground level (3 layers in total).",
        img: sup18,
        materials: [],
        labor: "1-2 men",
      },
      {
        ...
        img: sup19,
        materials: [
          "Different sizes of wood for door, maintenance slants, roof, storage floor",
        ],
        labor: "1-2 men",
      },
      {
      ...
      {
        description:
          "Nail the short wooden boards that form top and bottom to the sides.",
        img: sup21,
      ...
      {
        description:
          "Nail down the end of the tube onto the layer below and add two strings of barbed wire as before.",
        img: sup25,
        materials: ["1100m Four-point, two strand, galvanized barbed wire"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Stack 3 layers of gravel tubes on the inside. They will form a bench.",
        img: sup27,
        materials: ["630m Polypropylene Tubes"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "If it breaks into 2-4 big pieces: good. If it cracks but does not break: too much clay, add sand.",
        img: sup31,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Continuously control the position and roundness with the two strings.",
        img: sup36,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "After a tube-layer, place two strings of barbed wire on it, like before.",
        img: sup37,
        materials: ["1100m Four-point, two strand, galvanized barbed wire"],
        labor: "1-2 men",
      },
      {
        description:
          "Nail down the superadobe tubes with the long nails onto the layer below.",
        img: sup38,
        materials: ["2 kg Carpenter nails (90d, 22.5 cm)"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Add ventilation tubes at head height and on the top. Add wooden slats in a distance of 50 - 65 cm.",
        img: sup44,
        materials: [
          "Different sizes of wood for door, maintenance slants, roof, storage floor",
          "10m PVC Tubes (For ventilation)",
      ...
      {
        description:
          "Lay another 2 layers of superadobe tubes around the frame.",
        img: sup50,
        materials: ["630m Polypropylene Tubes"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Add a 2 strings of barbed wire around the whole building.",
        img: sup52,
        materials: ["1100m Four-point, two strand, galvanized barbed wire"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Make sure the ends of the tubes are not in the same location.",
        img: sup54,
        materials: [],
        labor: "1-2 men",
      },
      {
        description:
          "Once you reach an inner diameter of around 1 meter, add multiple ventilation tubes.",
        img: sup55,
        materials: ["10m PVC Tubes (For ventilation)"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Add water to get a muddy, kneadable texture, like a dough for a bread.",
        img: sup58,
        materials: ["Buckets"],
        labor: "1-2 men",
      },
      {
        description:
          "Add a little bit of sand and test a small patch of the plaster on the building. Let it dry in the shade.",
        img: sup59,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      {
        description:
          "If it cracks, it is too clayey and needs a bit more sand and/or fibers.",
        img: sup60,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      {
        description:
          "If it falls off in one piece, it has too much clay. Thin it out with sand.",
        img: sup61,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      {
        description:
          "Repeat the tests until you get only tiny cracks or no cracks.",
        img: sup62,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "First, try to level out the surface, by applying plaster to the gaps between the bags and the edges.",
        img: sup65,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      ...
      {
        description:
          "Don't smooth out the plaster. The next layer needs to grip onto something.",
        img: sup67,
        materials: ["35m3 of Soil"],
        labor: "1-2 men",
      },
      {
        description:
          "Always moisten the wall slightly before applying the next layer.",
        img: sup68,
        materials: ["Buckets"],
        labor: "1-2 men",
      },
